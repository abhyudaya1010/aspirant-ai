...
with st.sidebar:
  ...
  if not client:
    st.warning(
        "⚠️ GEMINI_API_KEY not found in secrets/env. Vision inspector needs"
        " it."
    )
...
NCERT_FULL_DATABASE = {
    ...
    "Class 11": {
        ...
        "Chemistry": [
            ...
            {
                "name": (
                    "Ch 8: Organic Chemistry - Some Basic Principles & Techniques"
                ),
    ...
    "Class 10": {
        "Science": [
            ...
            {
                "name": "Ch 4: Carbon and its Compounds",
                "url": "https://ncert.nic.in/textbook/pdf/jesc104.pdf",
            },
            {
                "name": "Ch 5: Life Processes",
                "url": "https://ncert.nic.in/textbook/pdf/jesc105.pdf",
            },
            {
                "name": "Ch 6: Control and Coordination",
                "url": "https://ncert.nic.in/textbook/pdf/jesc106.pdf",
            },
            {
                "name": "Ch 7: How do Organisms Reproduce?",
                "url": "https://ncert.nic.in/textbook/pdf/jesc107.pdf",
            },
            {
                "name": "Ch 8: Heredity",
            ...
            {
                "name": "Ch 9: Light - Reflection and Refraction",
            ...
            {
                "name": "Ch 11: Electricity",
                "url": "https://ncert.nic.in/textbook/pdf/jesc111.pdf",
            },
            {
                "name": "Ch 12: Magnetic Effects of Electric Current",
                "url": "https://ncert.nic.in/textbook/pdf/jesc112.pdf",
            },
            {
                "name": "Ch 13: Our Environment",
        ...
        "Mathematics": [
            ...
            {
                "name": "Ch 8: Introduction to Trigonometry",
                "url": "https://ncert.nic.in/textbook/pdf/jemh108.pdf",
            },
            {
                "name": "Ch 9: Some Applications of Trigonometry",
                "url": "https://ncert.nic.in/textbook/pdf/jemh109.pdf",
            },
            {
                "name": "Ch 10: Circles",
            ...
            {
                "name": "Ch 11: Areas Related to Circles",
                "url": "https://ncert.nic.in/textbook/pdf/jemh111.pdf",
            },
            {
                "name": "Ch 12: Surface Areas and Volumes",
                "url": "https://ncert.nic.in/textbook/pdf/jemh112.pdf",
            },
            {
                "name": "Ch 13: Statistics",
    ...
    "Class 9": {
        "Science": [
            {
                "name": "Ch 1: Matter in Our Surroundings",
                "url": "https://ncert.nic.in/textbook/pdf/iesc101.pdf",
            },
            {
                "name": "Ch 2: Is Matter Around Us Pure",
                "url": "https://ncert.nic.in/textbook/pdf/iesc102.pdf",
            },
            {
                "name": "Ch 3: Atoms and Molecules",
                "url": "https://ncert.nic.in/textbook/pdf/iesc103.pdf",
            },
            {
                "name": "Ch 4: Structure of the Atom",
                "url": "https://ncert.nic.in/textbook/pdf/iesc104.pdf",
            },
            {
                "name": "Ch 5: The Fundamental Unit of Life",
                "url": "https://ncert.nic.in/textbook/pdf/iesc105.pdf",
            },
            {
                "name": "Ch 6: Tissues",
                "url": "https://ncert.nic.in/textbook/pdf/iesc106.pdf",
            },
            {
                "name": "Ch 7: Motion",
                "url": "https://ncert.nic.in/textbook/pdf/iesc107.pdf",
            },
            {
                "name": "Ch 8: Force and Laws of Motion",
                "url": "https://ncert.nic.in/textbook/pdf/iesc108.pdf",
            },
            {
                "name": "Ch 9: Gravitation",
                "url": "https://ncert.nic.in/textbook/pdf/iesc109.pdf",
            },
            {
                "name": "Ch 10: Work and Energy",
                "url": "https://ncert.nic.in/textbook/pdf/iesc110.pdf",
            },
            {
                "name": "Ch 11: Sound",
            ...
            {
                "name": "Ch 12: Improvement in Food Resources",
                "url": "https://ncert.nic.in/textbook/pdf/iesc112.pdf",
            },
        ],
        "Mathematics": [
            {
            ...
            {
                "name": "Ch 2: Polynomials",
                "url": "https://ncert.nic.in/textbook/pdf/iemh102.pdf",
            },
            {
                "name": "Ch 3: Coordinate Geometry",
                "url": "https://ncert.nic.in/textbook/pdf/iemh103.pdf",
            },
            {
                "name": "Ch 4: Linear Equations in Two Variables",
                "url": "https://ncert.nic.in/textbook/pdf/iemh104.pdf",
            },
            {
                "name": "Ch 5: Introduction to Euclid's Geometry",
                "url": "https://ncert.nic.in/textbook/pdf/iemh105.pdf",
            },
            {
                "name": "Ch 6: Lines and Angles",
                "url": "https://ncert.nic.in/textbook/pdf/iemh106.pdf",
            },
            {
                "name": "Ch 7: Triangles",
                "url": "https://ncert.nic.in/textbook/pdf/iemh107.pdf",
            },
            {
                "name": "Ch 8: Quadrilaterals",
                "url": "https://ncert.nic.in/textbook/pdf/iemh108.pdf",
            },
            {
                "name": "Ch 9: Circles",
                "url": "https://ncert.nic.in/textbook/pdf/iemh109.pdf",
            },
            {
                "name": "Ch 10: Heron's Formula",
                "url": "https://ncert.nic.in/textbook/pdf/iemh110.pdf",
            },
            {
                "name": "Ch 11: Surface Areas and Volumes",
                "url": "https://ncert.nic.in/textbook/pdf/iemh111.pdf",
            },
            {
                "name": "Ch 12: Statistics",
                "url": "https://ncert.nic.in/textbook/pdf/iemh112.pdf",
            },
        ],
    },
}
...
if active_feature == "📚 NCERT Textbook Reader (Class 9–12)":
  ...
  with col_c:
    selected_class = st.selectbox(
        "Select Class", list(NCERT_FULL_DATABASE.keys())
    )
  with col_s:
  ...
  st.caption(
      "Upload or snap a photo of a worksheet. Gemini detects every single"
      " question and provides core concepts and Socratic steering hints."
  )
  ...
  user_context = st.text_input(
      "Optional context (e.g., 'Class 11 rotational dynamics sheet', or leave"
      " blank)",
      "",
  )
  ...
  if uploaded_img:
    ...
    with col_diag:
      if st.button("💡 Give Hints for Every Question", type="primary"):
        if not client:
          st.error(
              "Gemini client not initialized. Check your GEMINI_API_KEY secret."
          )
        else:
          HINT_PROMPT = f"""
            ...
            for attempt in range(max_retries):
              try:
                response = client.models.generate_content(
                    model="gemini-2.5-flash", contents=[image, HINT_PROMPT]
                )
